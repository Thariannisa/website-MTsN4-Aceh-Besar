...
<a class="btn btn-primary" href="/admin/berita/tambah" role="button">Tambah</a>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="/admin/berita/hapus" method="post">
                        ...
                        <?php foreach ($berita as $b) : ?>
                            <tr>
                                <th scope="row">
                                    ...
                                    <?= $i++; ?></th>
                                <td><img src="/gambar/berita/<?= $b['path_berita'] ?>" width="100px" height="100px" alt=""></td>
                                <td><a href="/admin/berita/detail/<?= $b['id']; ?>"><?= $b['judul_berita']; ?></a></td>
                                <td><?= $b['updated_at']; ?></td>
                                <?php $data = $user->where(['id' => $b['userId']])->first() ?>
                                <td><?= $data['nama'] ?></td>
                                <td><a class="btn btn-info" href="/admin/berita/edit/<?= $b['id']; ?>" role="button"><i class="fas fa-edit"></i></a>
                                </td>

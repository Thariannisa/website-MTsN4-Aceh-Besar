...
<a class="btn btn-primary" href="/admin/staff/pengajar/create" role="button">Tambah</a>
<!-- DataTales Example -->
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="/admin/staff/pengajar/delete" method="post">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($pengajar as $t) : ?>
                            <tr>
                                ...
                                <td><a class="btn btn-info" href="/admin/staff/pengajar/edit/<?= $t['id']; ?>" role="button"><i class="fas fa-edit"></i></a>
                                </td>

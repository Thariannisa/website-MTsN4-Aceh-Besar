...
<section class="detail-berita">
    <div class="container-fluid" style="padding: 0 30px;">
        <div class="row">
            <div class="col-md-8">
                <div class="judul">
                    <h6 class="judul-detail"><?= $b['judul_pengumuman']; ?></h6>
                ...
                <div class="gambar-detail">
                    <img class="img-detail" src="/gambar/pengumuman/<?= $b['path_pengumuman']; ?>" alt=""></div>
                <div class="isi-detail"><?= $b['isi_pengumuman']; ?></div>
                <?php if (strcmp('Tidak ada berkas', $b['file_pengumuman']) === 0) : ?>
                <?php else : ?>
                    <a href="/file/pengumuman/<?= ($b['file_pengumuman']) ? $b['file_pengumuman'] : 'default.png'; ?>" download class="btn btn-green">unduh</a>
                <?php endif; ?>
                <hr>
            </div>

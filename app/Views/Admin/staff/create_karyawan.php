...
<form action="<?= base_url('/admin/staff/karyawan'); ?>" enctype="multipart/form-data" method="post" id="formData">
    <?= csrf_field(); ?>
    <div class="row">
        <div class="col-md-10">
    ...
    <table class="table">
        ...
        <tbody class="formAdd">
            <tr>
                ...
                <td>
                    <input type="text" name="nama[]" class="form-control is-invalid" placeholder="Masukkan nama karyawan">
                </td>
                <td>
                    <input type="text" name="Status_Karyawan[]" class="form-control is-invalid" placeholder="Masukkan status karyawan">
                </td>
                <td>
                    <input type="text" name="Jabatan[]" class="form-control is-invalid" placeholder="Masukkan jabatan karyawan">
                </td>
                <td>
